                ...
                <form @submit.prevent="updateSubCategory(this.$route.params.id)">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" v-model="SubCategory.name" class="form-control" id="name"
                                placeholder="Enter Name">
                        </div>
                        <div class="form-group">
                            <label for="description">Description</label>
                            <input type="text" v-model="SubCategory.description" class="form-control" id="description"
...
export default {
    ...
    methods: {
        indexCategories() {
            axios.get(`${this.$store.state.url}/categories`).then((response) => {
        ...
        indexSubCategory(id) {
            axios.get(`${this.$store.state.url}/sub-categories/${id}`).then((response) => {
                console.log(response.data.data)
        ...
        updateSubCategory(id) {
            axios.put(`${this.$store.state.url}/sub-categories/${id}`, this.SubCategory).then((response) => {
