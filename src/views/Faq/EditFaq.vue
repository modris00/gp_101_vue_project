                ...
                <form @submit.prevent="updateFaq(this.$route.params.id)">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" v-model="faq.answer" class="form-control" id="answer" placeholder="answer">
                        </div>
                        <div class="col-sm-6">
                            <!-- select -->
                            <div class="form-group">
...
export default {
    ...
    methods: {
        ...
        indexFaq(id) {
            axios.get(`${this.$store.state.url}/faqs/${id}`).then((response) => {
        ...
        updateFaq(id) {
            axios.put(`${this.$store.state.url}/faqs/${id}`, this.faq).then((response) => {
